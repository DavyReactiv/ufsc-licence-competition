...
event_format_assert_same( EventFormatRegistry::STRATEGY_CARD, EventFormatRegistry::get_strategy( 'gala' ), 'gala default strategy remains card' );
...
event_format_assert_same( true, EventFormatRegistry::supports_brackets( 'gala' ), 'gala can contain tournament block' );
event_format_assert_same( true, EventFormatRegistry::supports_program_mode( 'gala', EventProgramRegistry::MODE_TOURNAMENT ), 'gala tournament program mode' );
event_format_assert_same( true, EventFormatRegistry::supports_mixed_program( 'gala' ), 'gala hybrid program capability' );

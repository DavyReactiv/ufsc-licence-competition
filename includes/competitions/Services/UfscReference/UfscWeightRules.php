	...
	public static function all(): array {
		...
		return array(
			'default' => array(
				...
				'f'       => $tatami,
				'age_groups' => array(
					'default' => array( 'neutral' => $tatami, 'm' => $tatami, 'f' => $tatami ),
				),
			),
			'tatami'  => array(
				'neutral' => $tatami,
				...
				'f'       => $tatami,
				'age_groups' => array(
					'cadet' => array( 'neutral' => $tatami, 'm' => $tatami, 'f' => $tatami ),
					'junior' => array( 'neutral' => $tatami, 'm' => $junior_tatami_m, 'f' => $junior_tatami_f ),
					'senior' => array( 'neutral' => $tatami, 'm' => $tatami, 'f' => $tatami ),
				),
			),
			'ring'    => array(
				'neutral' => $ring,
				...
				'f'       => $ring,
				'age_groups' => array(
					'junior' => array( 'neutral' => $ring, 'm' => $ring, 'f' => $ring ),
					'senior' => array( 'neutral' => $ring, 'm' => $senior_ring_m, 'f' => $senior_ring_f ),
				),
			),
		);
	}

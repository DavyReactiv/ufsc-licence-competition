...
function load_competitions_core_dependencies(): void {
	...
	$core_files = array(
		...
		$base . '/Entries/EntryDataNormalizer.php',
		...
		$base . '/Services/FighterNumberService.php',
		...
		$base . '/Services/CompetitionSafetyService.php',
		$base . '/Services/CompetitionStatsService.php',
		$base . '/Services/CategoryPresetService.php',
...
function load_competitions_admin_dependencies(): void {
	...
	$admin_files = array(
		...
		$base . '/Admin/Pages/Results_Page.php',

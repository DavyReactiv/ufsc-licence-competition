...
if ( ! class_exists( 'UFSC_Competition_Licences_List_Table' ) ) {
	class UFSC_Competition_Licences_List_Table extends WP_List_Table {
		...
		public function __construct() {
			...
			$this->has_created_at = $this->has_column( 'created_at' );
		}
		...
		public function prepare_items() {
			...
			if ( '' !== $search ) {
				...
				$where[] = '(l.nom_licence LIKE %s OR l.prenom LIKE %s OR l.email LIKE %s OR d.source_licence_number LIKE %s OR c.nom LIKE %s)';
			...
			$item_params = array_merge( array( 'ASPTT' ), $params, array( $per_page, $offset ) );

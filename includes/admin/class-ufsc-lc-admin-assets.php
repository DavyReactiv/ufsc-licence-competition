		...
		if ( $js_found ) {
			...
			wp_localize_script(
				...
				array(
					...
					'nonces'       => array(
						'admin'      => wp_create_nonce( 'ufsc_lc_admin_nonce' ),
						'searchClubs' => wp_create_nonce( 'ufsc_lc_admin_nonce' ),
					...
					'strings'      => array(
						...
						'confirmDelete'    => __( 'Confirmer la suppression ?', 'ufsc-licence-competition' ),
					),
				)
			);
		}

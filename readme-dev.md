...
nonce : ufsc_competitions_download_plateau_pdf (plateau / controle)
nonce : ufsc_competitions_download_fiche_pdf (fiche / fiche_complete)
...
- Tester l’export PDF avec Dompdf absent pour valider le message d’indisponibilité.
